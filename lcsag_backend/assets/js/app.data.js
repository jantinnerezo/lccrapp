$(document).ready(function() {
	...
	// datatable
	$('[data-ride="datatables-categories"]').each(function() { 
		var oTable = $(this).dataTable( {
			"bProcessing": true,
			"sAjaxSource": "http://"+url_location+"/admin/categories/get_categories/",
			"sDom": "<'row'<'col-sm-1'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col col-sm-6'p>>",
  ...
  $('[data-ride="datatables-users"]').each(function() { 
		  var search_str = window.location.search;
		  var url_location = window.location.hostname ; 
          var oTable = $(this).dataTable( {
            "bProcessing": true, 
            "sAjaxSource": "http://"+url_location+window.location.pathname+"get_users/"+search_str, 
            // "sAjaxSource": "http://"+url_location+"/admin/users/get_users/"+search_str, 
  ...
  $('[data-ride="datatables-user-groups"]').each(function() {  
          var oTable = $(this).dataTable( {
            "bProcessing": true,
            "sAjaxSource": "http://"+url_location+"/admin/users/get_user_roles/",
            "sDom": "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col col-sm-6'p>>",
            "sPaginationType": "full_numbers",
            "aoColumns": [ 
              { "mData": "group_name" }, 
  ...
  $('[data-ride="datatables-orders"]').each(function() {  
          var oTable = $(this).dataTable( {
            "bProcessing": true,
            "sAjaxSource": "http://"+url_location+"/admin/orders/get_orders/",
            "sDom": "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col col-sm-6'p>>",
            "sPaginationType": "full_numbers",
            "aoColumns": [ 
